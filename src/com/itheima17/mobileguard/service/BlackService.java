...
public class BlackService extends Service {
	...
	private void setForeApp() {
		Notification notification = new Notification(R.drawable.heima, "打开", System.currentTimeMillis());
		Intent intent = new Intent("itheima.home");
		PendingIntent contentIntent = PendingIntent.getActivity(getApplicationContext(), 0, intent , 0);
		notification.setLatestEventInfo(getApplicationContext(), "打开", "打开主界面", contentIntent );
