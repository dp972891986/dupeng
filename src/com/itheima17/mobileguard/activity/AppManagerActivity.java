...
import com.itheima17.mobileguard.utils.DensityUtil;
 ...
 * @svn date $Date: 2015-12-06 17:03:25 +0800 (Sun, 06 Dec 2015) $
 * @Id $Id: AppManagerActivity.java 103 2015-12-06 09:03:25Z goudan $
 * @version $Rev: 103 $
 * @url $URL:
		...
		mLv_datas.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (mPw.isShowing()) {
					...
					// 显示
					int dip = 50;
					mPw.showAsDropDown(view, DensityUtil.dip2px(getApplicationContext(), dip), -view.getHeight());// 50px
				}
